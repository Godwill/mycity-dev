...
<?php
  ...
  if(isset($url[0])){ $system = $url[0]; }     
     

 $sql = "SELECT id, title, body, system, uid, category, created, section, picture FROM articles where system='{$system}' AND type=2 Limit 1";
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/all.js#xfbml=1&appId=226226674059813";
