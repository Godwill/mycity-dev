<?php include '../system/initialize.php'; ?>
  ...
  <?php 
      ...
      #print_r($url[2]);
 if(isset($url[1])){
          if(isset($url[2]) && $url[2] == "directory"){
        ...
        View::render('hotels');
      }elseif(isset($url[2]) && $url[2] == "wedding-planner"){
        ...
        View::render('cars');
      }elseif(isset($url[2]) && $url[2] == "craftshop"){
        View::render('craftshop');
      }else{
...
<div class="top-posts divide">
  ...
  <ul>
    <?php
      $article = Article::find_by_sql("SELECT * FROM articles WHERE country='na' ORDER BY created DESC LIMIT 5");
  ...
  <h1>Featured Companies</h1>
    <?php 
      $companies = Company::find_by_sql("SELECT * FROM companies WHERE featured=1 and country='na' ORDER BY CREATED LIMIT 5");
 ...
 <h1>Restaurants In Botswana</h1>
  <ul>
    <?php
      $companies = Company::find_by_sql("SELECT * FROM companies WHERE industry=12 AND country='na' ORDER BY CREATED LIMIT 10");
      foreach($companies as $company):      
    ?>
    <div class="front-list">
      <div class="front-list-pic">
