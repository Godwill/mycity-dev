...
class Branch {
	...
	protected static $db_fields = array('id', 'company_id', 'name', 'address_line_1', 
         'address_line_2','address_line_3', 'postal_1', 'postal_2', 'tel', 'fax', 'email', 
         'branchCode', 'city', 'created'); 
