...
class Wedding{
	...
	protected static $table_name = "weddings";
	protected static $db_fields = array('id', 'couple_name', 'fiance_fname', 'fiance_lname', 'wedding_date', 
			'country', 'city', 'province', 'location', 'type', 'color1', 'color2', 'color3', 'created', 'uid', );
