...
if(isset($_GET['q'])){
	...
	$sql = "SELECT * FROM companies WHERE id='{$system}'";
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
      ...
      <navigation>
        <ul>
          ...
          <li><a href="<?php echo PATH ?>dineout/">CHEF'S SPECIALS</a></li>
          <li><a href="<?php echo PATH ?>dineout/reviews">REVIEWS</a></li>
          <li><a href="<?php echo PATH ?>dineout/">FAVORITES</a> </li>
...
<div class="fb-like" data-href="<?php echo PATH?>dineout/<?php echo $company->id; ?>/<?php echo $company->system; ?>" data-send="true" data-layout="button_count" data-width="120" data-show-faces="true"></div>
   ...
   <div class="tab-pane " id="reviews">
     <div class="fb-comments" data-href="http://www.seemycity.net/<?php code_to_country($company->country); ?>/dineout/<?php $rid = $company->id; ?>/<?php $rid = $company->system; ?>" data-num-posts="10" data-width="720"></div>
