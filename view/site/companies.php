...
<?php 
    ...
    $companies = Company::find_by_sql("SELECT * FROM companies WHERE country ='{countryCode}'");
    foreach ($companies as $company): ?>
<div class="list-container span-190">
  
   <?php echo $countryCode.'</p>'; ?>
...
<div class="profile-logo">
  ...
  <strong>Facebook</strong> <a href="http://www.facebook.com/<?php echo $company->facebook; ?>" target="_blank">AM Engineering</a></br>
  <strong>LinkedIn</strong> <a href="http://www.linkedin.com/<?php echo $company->linkedin; ?>" target="_blank">AM Engineering Pty Ltd</a></br>
